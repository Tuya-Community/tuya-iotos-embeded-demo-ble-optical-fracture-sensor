...
static const char auth_key_test[] = "H7S9qcojfxvvgl9Ao3r8suVtZYbQi9D8";
static const char device_id_test[] = "tuyaa3efe758d357";
static const uint8_t mac_test[6] = {0xB8,0x41,0x31,0x4D,0x23,0xDC}; //The actual MAC address is : DC234D3141B8
